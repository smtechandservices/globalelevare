...
export default function Pricing() {
  return (
    <div id="packages" className="px-5 md:px-[60px] pt-10 pb-14 scroll-mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {packages.map((k) => (
          ...
          >
            ...
            <div className="font-condensed font-semibold text-5xl leading-tight mt-2.5 mb-1 tabular-nums">
              {k.price}
            </div>
